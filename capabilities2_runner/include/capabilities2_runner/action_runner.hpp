...
public:
                           ...
                           std::function<void(const std::string&)> on_terminated = nullptr)
  {
    ...
    // initialize the clock used for message timestamps
    ...
    send_goal_options_.goal_response_callback =
        [this, on_started,
         on_terminated](const typename rclcpp_action::ClientGoalHandle<ActionT>::SharedPtr& goal_handle) {
    ...
    send_goal_options_.result_callback =
        [this, on_started,
         on_terminated](const typename rclcpp_action::ClientGoalHandle<ActionT>::WrappedResult& wrapped_result) {
